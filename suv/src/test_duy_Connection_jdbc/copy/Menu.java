...
提供各个功能的按钮此类未使用布局， 所以使用坐标固定了各个标签和按钮的位置
*/

public class Menu extends JFrame implements ActionListener{

    JButton jb1, jb2, jb3,jb4,jb5,jb6,jb7, jb8, jb9;  //创建按钮
    ...
    public Menu() 
    {
        ...
        jlb1 = new JLabel("贰壹零之东方银行");
        jlb1.setFont(new   java.awt.Font("Dialog",   1,   16)); //设置字体类型， 是否加粗，字号
        jlb2 = new JLabel("Welcome !");
        jlb2.setFont(new   java.awt.Font("Dialog",   1,   16));
        ...
        jb4.setBounds( 404,50,90,60);
        jb5.setBounds( 404,150,90,60);
        jb6.setBounds( 404,250,90,60);
        jb7.setBounds( 404,350,90,60);
        jb9.setBounds( 202,350,90,60);
        //设置标签的位置和大小
        jlb1.setBounds(180,0,150,50);
        jlb2.setBounds(200,30,150,50);
        jlb3.setBounds(180,250,150,50);
