...
public class Transfer extends JFrame implements ActionListener{
    ...
    private void transfer(){
        ...
        {
            JOptionPane.showMessageDialog(null, "金额为空，请重新输入！","温馨提示",JOptionPane.WARNING_MESSAGE);
        }
        else if (jtf1.getText().isEmpty())
        {
            JOptionPane.showMessageDialog(null, "转入账号为空，请重新输入！","温馨提示",JOptionPane.WARNING_MESSAGE);
        }
        else if(new Check().checkmoney(jta1.getText()))  //验证金额是否合法
        {
            ...
            {
                JOptionPane.showMessageDialog(null, "账户不存在","温馨提示",JOptionPane.WARNING_MESSAGE);
                //clear();
            }
        ...
        {
            JOptionPane.showMessageDialog(null, "金额不合法","温馨提示",JOptionPane.WARNING_MESSAGE);
            clear();
        }
